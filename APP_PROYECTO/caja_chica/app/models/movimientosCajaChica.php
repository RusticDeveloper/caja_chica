...
function addMove($information,$archivo='noFile')
{
   ...
   $query1  = 'UPDATE caja_chica SET restante_caja_chica=:restante WHERE id=:idCajaChica';
   $statement1=$db->prepare($query1);

   $remainingCash=floatval(getCurrentPettyBoxValue($information['idCajaChica'])['restante_caja_chica'])-floatval($information['monto']);
