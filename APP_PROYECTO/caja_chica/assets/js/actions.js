...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function goToReport(accion) {
        ...
        ruta = document.location.pathname + '?action=' + accion;
    ...
    function checkZise() {
        ...
        if (tamano>2097152) {
            console.log('el archivo pesa mas de 2 MB')
            mensaje.innerHTML='el archivo pesa mas de 2 MB, debe ser menor';
            archivo.value=null;
        } else {
            console.log('el archivo es menor a 2 MB, se puede subir');
...
function sendSettlementAction(mensaje, identificacion = '') {
    // alert('Hola '+mensaje);
    window.location.href = '../../app/controllers/listaArqueosCajaChica.controller.php?action=' + mensaje + '&identificador=' + identificacion;
}
function sendSettlementReport(mensaje, identificacion = '') {
    // alert('Hola '+mensaje);
    // window.location.href = ;
    window.open('../../app/controllers/reportes.controller.php?action=' + mensaje + '&identificador=' + identificacion, "_blank");
}
